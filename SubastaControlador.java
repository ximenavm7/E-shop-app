...
public class SubastaControlador implements ActionListener, ListSelectionListener {
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        try {
            ...
            } else if (evento.getActionCommand().equals("Iniciar Sesión")) { // Nueva lógica para Iniciar Sesión
                usuario = vista.getUsuario();
                if (usuario == null || usuario.isEmpty()) {
                    System.out.println("Debe ingresar un nombre de usuario para iniciar sesión.");
                    return;
                }
